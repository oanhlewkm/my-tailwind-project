...
export default function Home() {
  return (
    <main>
      <div>
        <div id="section1" className="relative flex flex-column">
          <div className="flex justify-start py-20 px-8 md:px-20">
            <div className="px-0 md:px-7">
              <div className="flex-column text-left space-y-10 md:w-2/4">
        ...
        <div id="section2">
          <div className="flex justify-center py-20 px-8 md:px-20">
            <div className="flex-column text-center md:text-left space-y-4 md:w-2/4">
              <h2
        ...
        <div id="section3" style={{ background: "#302644" }}>
          <div className="container mx-auto flex justify-center pt-20">
            <div className="flex-column space-y-3 text-white text-center">
